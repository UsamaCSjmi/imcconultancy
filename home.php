    ...
    <div class="row w-100 mb-2">
      ...
      while ($country = mysqli_fetch_assoc($countries)) { ?>
        <div class="col-lg-3 col-md-6 col-sm-12">
          <div class="card m-2">
            <img src="<?php echo SITE_PATH . "/assets/images/countries/" . $country['image'] ?>" class="card-img-top" alt="<?php echo $country['name'] ?>" style="height:10rem">
            <div class="card-body">
              <h5 class="card-title"><?php echo $country['name'] ?></h5>
              <p class="card-text">
                MBBS in <?php echo $country['name'] ?>
                <br>
                <span class="text-danger">Fees : 2.5 Lacs/year</span>
              </p>
              <a href="<?php echo SITE_PATH ?>/mbbs-in-<?php echo strtolower($country['name']) ?>" class="btn btn-dark">View</a>
            </div>
          </div>
        </div>
      <?php } ?>
